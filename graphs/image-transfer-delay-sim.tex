...
\begin{figure}[ht]
  ...
  \end{tikzpicture}
  \IfLanguageName{english}{
    \caption{Delay results compared to the data size of image transfer in the simulation.}
  }{
    \caption{Hasil \emph{delay} dibandingkan ukuran data dari pengiriman citra di simulasi.}
  }
