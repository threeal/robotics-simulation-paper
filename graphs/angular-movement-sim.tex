...
\begin{figure}[ht]
  ...
  \end{tikzpicture}
  \IfLanguageName{english}{
    \caption{Comparison of last orientation results from the expected and measured values in the simulation.}
  }{
    \caption{Perbandingan hasil orientasi akhir dari nilai yang diharapkan dan yang terukur di simulasi.}
  }
