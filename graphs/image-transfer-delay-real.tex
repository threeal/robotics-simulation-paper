...
\begin{figure}[ht]
  ...
  \end{tikzpicture}
  \IfLanguageName{english}{
    \caption{Delay results compared to the data size of image transfer on the real robot.}
  }{
    \caption{Hasil \emph{delay} dibandingkan ukuran data dari pengiriman citra pada robot fisik.}
  }
